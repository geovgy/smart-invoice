...
export function FeatureCrypto() {
  return (
    <Box padding={20}>
      <Heading mb={2}>Accept cryptocurrency payments for your work</Heading>
      <Text mb={10}>
        Choose from 30+ tokens to get paid with, including ETH, USDC, xDAI, and
        more!
      </Text>
      <Grid
      ...
      >
        ...
        <GridItem maxWidth={310}>
          ...
          <Text>
            Escrow funds are secured via a smart contract until released to your
            wallet.
          </Text>
        </GridItem>
        <GridItem maxWidth={310}>
